              ...
              <div className="row">
                ...
                >
                  <div className="project-featured-box">
                    <div className="img1">
                      <img
                        src="/assets/img/selecting.png"
                        alt="Special Pumps"
                      />
                    </div>
                    <div className="space40" />
                    <Link href="/products/chemical-process" className="head">
                      Pump Selection & Sizing
                    </Link>
                    <div className="space16" />
                    <p>
                      Get the right pump first time. Share flow, head,
                      temperature, and fluid; receive a matched model and BOM.
                    </p>
                    <div className="space24" />
                ...
                >
                  <div className="project-featured-box">
                    <div className="img1">
                      <img
                        src="/assets/img/installataion.png"
                        alt="Special Pumps"
                      />
                    </div>
                    <div className="space40" />
                ...
                >
                  <div className="project-featured-box">
                    ...
                    <div className="space16" />
                    <p>
                      Preventive service, overhauls, seals, bearings, and OEM
                      spares to keep uptime high and costs low.
                    </p>
                    <div className="space24" />
                    <div className="btn-area1">
                      <Link href="/contact" className="theme-btn5">
                      ...
                      <div className="col-lg-5">
                        <Slider {...settings2} className="images-area2 slider2">
                          <div className="img1 image-anime">
                            <img
                              src="property/testinomials.webp"
                              alt="Special Pumps"
                            />
                          </div>
                          <div className="img1 image-anime">
                      ...
                      <div className="col-lg-7">
                        ...
                        >
                          <div className="testimonial-box">
                            ...
                            <div className="space16" />
                            <p>
                              "Special Pumps surveyed our site, sized the right
                              booster, and installed it the same day with a
                              clean, quiet setup that finally stabilized our
                              water pressure across all floors.
                            </p>
                          ...
                          <div className="testimonial-box">
                            ...
                            <div className="space16" />
                            <p>
                              "The team’s commissioning checklist and training
                              were clear, and they fine‑tuned the system to cut
                              cycling and noise while improving efficiency
                              during peak hours.They also specified durable
                              materials for our abrasive flow, which stopped
                              leaks and slashed maintenance calls over the last
                              quarter"
                            </p>
                            <div className="space32" />
                            <div className="test-images">
                          ...
                          <div className="testimonial-box">
                            ...
                            <p>
                              ...
                              perfect options.Their commissioning and training
                              were clear, and they fine‑tuned setpoints to cut
                              cycling and noise while improving efficiency
                              during peak demand."
                            </p>
                            <div className="space32" />
                          ...
                          <div className="testimonial-box">
                            ...
                            <div className="space16" />
                            <p>
                              "Support has been proactive with checks and
                              alerts, so we’ve had zero unplanned downtime even
                              through heavy rains."
                            </p>
                            <div className="space32" />
                            <div className="test-images">
                      ...
                      <div className="col-lg-5">
                        <div className="cta-header">
                          ...
                          <p data-aos="fade-left" data-aos-duration={1000}>
                            ...
                            than just a place it's where your future begins you
                            are buy.
                          </p>
                        </div>
                      </div>
