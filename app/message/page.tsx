									...
									<div className="dashboard-info-sider-deatils">
										<div className="dashboard-info-sider">
											<div className="message-boxarea">
												<div className="img1">
													<img src="/assets/img/all-images/others/dash-img5.png" alt="Special Pumps" />
												</div>
											...
											<div className="message-boxarea">
												...
												<div className="img1">
													<img src="/assets/img/all-images/others/dash-img6.png" alt="Special Pumps" />
												</div>
												<div className="conatent-area">
													<div className="content">
											...
											<div className="message-boxarea">
												<div className="space32" />
												<div className="img1">
													<img src="/assets/img/all-images/others/dash-img7.png" alt="Special Pumps" />
												</div>
												<div className="conatent-area">
													<div className="content">
											...
											<div className="message-boxarea">
												<div className="space32" />
												<div className="img1">
													<img src="/assets/img/all-images/others/dash-img8.png" alt="Special Pumps" />
												</div>
												<div className="conatent-area">
													<div className="content">
											...
											<div className="message-boxarea" style={{ borderBottom: 'none', padding: 0 }}>
												<div className="space32" />
												<div className="img1">
													<img src="/assets/img/all-images/others/dash-img9.png" alt="Special Pumps" />
												</div>
												<div className="conatent-area">
													<div className="content">
